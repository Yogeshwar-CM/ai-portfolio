...
export default async function CaseStudy({ params }: Params) {
  ...
  const siblings = studies.filter((p) => p.slug !== project.slug);
    ...
    <article className="relative z-10 pb-24 pt-28 md:pt-36">
      <div className="shell">
        <Reveal>
          ...
          <p className="pretty mt-6 max-w-2xl text-[1.05rem] leading-relaxed text-muted">
            {project.summary}
          </p>
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-12 lg:gap-14">
          <Reveal delay={80} className="lg:col-span-8">
            <p className="pretty serif text-[1.35rem] leading-[1.6] text-text/90 md:text-[1.5rem]">
              {study.intro}
            </p>
                  ...
                  <div className="mt-5 space-y-4">
                    {section.body.map((paragraph) => (
                      <p
                        ...
                        className="pretty text-[0.98rem] leading-[1.75] text-muted"
                      >
                        {paragraph}
                      </p>
                    ))}
